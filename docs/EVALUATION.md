...
| 11 | Testing | ★★★★★ | 107 tests — 22 API unit + 6 crypto unit + 58 integration (real PG) + 6 worker + 13 web + 2 Playwright e2e; coverage-gated; compose smoke; autocannon benchmark. Authenticated browser e2e is environment-gated | — |
